...
class CodeForm(forms.Form):
    ...
    code_text = forms.CharField(label="Code:", widget=forms.Textarea(attrs={'id': 'code_text', 'onchange':'submit()'}), required=False)# 'placeholder': 'Enter your code here'}))
